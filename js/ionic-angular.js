...
function RepeatManagerFactory($rootScope, $window, $$rAF) {
  ...
  return function RepeatController(options) {
    ...
    function StaticViewType() {
      ...
      // while scrolling. This could be dangerous if this was a include function, but it's not.
      // Only we use it.
      var dim = {};
 ...
 * and then try to load main.html into the `<ion-nav-view>`.
 *
 * Pages are loaded by the URLs given. One simple way to create templates in Angular is to put
 * them directly into your HTML file and use the `<script type="text/ng-template">` syntax.
 * So here is one way to put main.html into our app:
 *
 * ```html
